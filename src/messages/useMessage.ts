...
import { ORTEGE_EXPLORER_API_URL } from '../consts';
...
export function useMessage({
  messageId,
  originTxHash,
  explorerApiUrl = ORTEGE_EXPLORER_API_URL,
  retryInterval = 2000,
}: Params) {
...
async function fetchMessage(
  ...
  if (!messageId && !originTxHash) throw new Error('Either messageId or originTxHash required');
